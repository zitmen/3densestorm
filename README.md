**3denseSTORM** is a MATLAB program for analysis of 2D and 3D STORM data with high molecular density and it is based on the algorithm secribed in our [paper](https://www.osapublishing.org/oe/abstract.cfm?uri=oe-22-25-31263):
...
* Automated calibration:
    ...
    * Estimation of real psf from calibration stack